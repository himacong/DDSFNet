...
def test(args):
    ...
    with torch.no_grad():
        ...
        for data_ir, data_vi, mask, img_name in iter:
            data_vi, data_ir,mask = data_vi.to(device), data_ir.to(device),mask.to(device)
...
if __name__ == "__main__":
    ...
    # parse.add_argument('--out_dir', type=str, default=f'autodl-tmp/fus_22')
